...
namespace MX.Observability.ApplicationInsights.WorkerService;

/// <summary>
/// Worker Service / Azure Functions (isolated) registration entry point for MX Observability.
/// </summary>
public static class ServiceCollectionExtensions
{
    /// <summary>
    /// Registers MX Observability for a Worker Service / Functions isolated host.
    /// <para>
    /// Call this after <c>services.AddApplicationInsightsTelemetryWorkerService()</c>. This method:
    /// </para>
    /// <list type="bullet">
    ...
    /// <summary>
    /// Registers MX Observability for a Worker Service / Functions isolated host with custom filter configuration.
    /// </summary>
