# AGENTS.md — observability-appinsights

Repository `observability-appinsights` in the frasermolyneux organization. Adapt this brief with repo-specific scope and validation commands.
